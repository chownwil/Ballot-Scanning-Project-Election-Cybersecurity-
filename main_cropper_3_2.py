...
def rect_detect(filepath):
	...
	for i in range(len(bubbles)):
		for j in range(len(bubbles[i])):
			...
			x=t[0]
			y=t[1]
			imageio.imwrite('bubbles2_2/{}_{}_{}_{}.jpg'.format(jpg_number,pagetype,i,j), im_gs[y+top_left_y:y+top_left_y+40,x+top_left_x:x+top_left_x+60])
